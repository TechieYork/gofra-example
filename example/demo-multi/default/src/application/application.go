...
import (
	...
	"github.com/TechieYork/gofra-example/example/demo-multi/default/src/common"
	"github.com/TechieYork/gofra-example/example/demo-multi/default/src/config"

	//!!!DO NOT EDIT!!!
	health_check "github.com/TechieYork/gofra-example/example/demo-multi/default/src/proto/health_check"
	user "github.com/TechieYork/gofra-example/example/demo-multi/default/src/proto/user"
	/*@PROTO_STUB*/
	HealthCheckServiceHandler "github.com/TechieYork/gofra-example/example/demo-multi/default/src/handler/HealthCheckService"
	UserServiceHandler "github.com/TechieYork/gofra-example/example/demo-multi/default/src/handler/UserService"
	/*@HANDLER_STUB*/
)
...
func (app *Application) Init(conf *config.Config) error {
	...
	// init monitor
	monitor.Init("127.0.0.1:8125", "default", common.ProjectName)
...
func (app *Application) Run(address string) error {
	...
	user.RegisterUserServiceServer(s, UserServiceHandler.UserServiceImpl{})
	/*@REGISTER_STUB*/
