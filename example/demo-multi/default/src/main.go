...
import (
	...
	config "github.com/TechieYork/gofra-example/example/demo-multi/default/src/config"
	application "github.com/TechieYork/gofra-example/example/demo-multi/default/src/application"
)

func main() {
	// start
	fmt.Println("====== Server [default] Start ======")
