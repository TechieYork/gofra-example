...
import (
	...
	config "github.com/TechieYork/gofra-example/example/demo-multi/serviceB/src/config"
	application "github.com/TechieYork/gofra-example/example/demo-multi/serviceB/src/application"
)

func main() {
	// start
	fmt.Println("====== Server [serviceB] Start ======")
