...
import (
	...
	"github.com/TechieYork/gofra-example/example/demo-multi/serviceB/src/common"
	"github.com/TechieYork/gofra-example/example/demo-multi/serviceB/src/config"
	...
	/*@PROTO_STUB*/
	HealthCheckServiceHandler "github.com/TechieYork/gofra-example/example/demo-multi/serviceB/src/handler/HealthCheckService"
	AgeServiceHandler "github.com/TechieYork/gofra-example/example/demo-multi/serviceB/src/handler/AgeService"
	/*@HANDLER_STUB*/
)
...
func (app *Application) Init(conf *config.Config) error {
	...
	// init monitor
	monitor.Init("127.0.0.1:8125", "serviceB", common.ProjectName)
...
func (app *Application) Run(address string) error {
	...
	age.RegisterAgeServiceServer(s, AgeServiceHandler.AgeServiceImpl{})
	/*@REGISTER_STUB*/
