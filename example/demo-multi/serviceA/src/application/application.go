...
import (
	...
	"github.com/TechieYork/gofra-example/example/demo-multi/serviceA/src/common"
	"github.com/TechieYork/gofra-example/example/demo-multi/serviceA/src/config"

	//!!!DO NOT EDIT!!!
	health_check "github.com/TechieYork/gofra-example/example/demo-multi/serviceA/src/proto/health_check"
	name "github.com/TechieYork/gofra-example/example/demo-multi/serviceA/src/proto/name"
	/*@PROTO_STUB*/
	HealthCheckServiceHandler "github.com/TechieYork/gofra-example/example/demo-multi/serviceA/src/handler/HealthCheckService"
	NameServiceHandler "github.com/TechieYork/gofra-example/example/demo-multi/serviceA/src/handler/NameService"
	/*@HANDLER_STUB*/
)
...
func (app *Application) Init(conf *config.Config) error {
	...
	// init monitor
	monitor.Init("127.0.0.1:8125", "ServiceA", common.ProjectName)

	// init tracing
	tracing.Init("http://127.0.0.1:9411/api/v1/spans", "false", ":60001", "ServiceA")
...
func (app *Application) Run(address string) error {
	...
	name.RegisterNameServiceServer(s, NameServiceHandler.NameServiceImpl{})
	/*@REGISTER_STUB*/
