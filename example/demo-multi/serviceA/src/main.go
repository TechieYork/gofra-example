...
import (
	...
	config "github.com/TechieYork/gofra-example/example/demo-multi/serviceA/src/config"
	application "github.com/TechieYork/gofra-example/example/demo-multi/serviceA/src/application"
)

func main() {
	// start
	fmt.Println("====== Server [ServiceA] Start ======")
