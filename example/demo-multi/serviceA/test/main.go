...
func main() {
	fmt.Println("====== Test [ServiceA] begin ======")
	defer fmt.Println("====== Test [ServiceA] end ======")

    // init log
    logger.Init("../conf/log.config", "ServiceA_test")

	// init monitor
	monitor.Init("127.0.0.1:8125", "ServiceA")
	...
	addr := commonUtils.GetRealAddrByNetwork(":60001")
