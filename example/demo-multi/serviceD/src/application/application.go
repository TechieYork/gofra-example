...
import (
	...
	"github.com/TechieYork/gofra-example/example/demo-multi/serviceD/src/common"
	"github.com/TechieYork/gofra-example/example/demo-multi/serviceD/src/config"

	//!!!DO NOT EDIT!!!
	health_check "github.com/TechieYork/gofra-example/example/demo-multi/serviceD/src/proto/health_check"
	addr "github.com/TechieYork/gofra-example/example/demo-multi/serviceD/src/proto/addr"
	/*@PROTO_STUB*/
	HealthCheckServiceHandler "github.com/TechieYork/gofra-example/example/demo-multi/serviceD/src/handler/HealthCheckService"
	AddrServiceHandler "github.com/TechieYork/gofra-example/example/demo-multi/serviceD/src/handler/AddrService"
	/*@HANDLER_STUB*/
)
...
func (app *Application) Init(conf *config.Config) error {
	...
	// init monitor
	monitor.Init("127.0.0.1:8125", "serviceD", common.ProjectName)

	// init tracing
	tracing.Init("http://127.0.0.1:9411/api/v1/spans", "false", ":60004", "serviceD")
...
func (app *Application) Run(address string) error {
	...
	addr.RegisterAddrServiceServer(s, AddrServiceHandler.AddrServiceImpl{})
	/*@REGISTER_STUB*/
