...
import (
	...
	config "github.com/TechieYork/gofra-example/example/demo-multi/serviceD/src/config"
	application "github.com/TechieYork/gofra-example/example/demo-multi/serviceD/src/application"
)

func main() {
	// start
	fmt.Println("====== Server [serviceD] Start ======")
