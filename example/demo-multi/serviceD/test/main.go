...
func main() {
	fmt.Println("====== Test [serviceD] begin ======")
	defer fmt.Println("====== Test [serviceD] end ======")

    // init log
    logger.Init("../conf/log.config", "serviceD_test")

	// init monitor
	monitor.Init("127.0.0.1:8125", "serviceD")
	...
	addr := commonUtils.GetRealAddrByNetwork(":60004")
