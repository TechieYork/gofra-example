...
func main() {
	fmt.Println("====== Test [serviceC] begin ======")
	defer fmt.Println("====== Test [serviceC] end ======")

    // init log
    logger.Init("../conf/log.config", "serviceC_test")

	// init monitor
	monitor.Init("127.0.0.1:8125", "serviceC")
	...
	addr := commonUtils.GetRealAddrByNetwork(":60003")
