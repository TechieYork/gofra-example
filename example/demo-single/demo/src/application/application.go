...
import (
	...
	"github.com/DarkMetrix/gofra/tmp/demo/src/common"
	"github.com/DarkMetrix/gofra/tmp/demo/src/config"

	//!!!DO NOT EDIT!!!
	health_check "github.com/DarkMetrix/gofra/tmp/demo/src/proto/health_check"
	user "github.com/DarkMetrix/gofra/tmp/demo/src/proto/user"
	/*@PROTO_STUB*/
	HealthCheckServiceHandler "github.com/DarkMetrix/gofra/tmp/demo/src/handler/HealthCheckService"
	UserServiceHandler "github.com/DarkMetrix/gofra/tmp/demo/src/handler/UserService"
	/*@HANDLER_STUB*/
)
...
func (app *Application) Init(conf *config.Config) error {
	...
	// init monitor
	monitor.Init("127.0.0.1:8125", "demo", common.ProjectName)

	// init tracing
	tracing.Init("http://127.0.0.1:9411/api/v1/spans", "false", "localhost:58888", "demo")
